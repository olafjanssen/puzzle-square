 ...
 */
(function (e, t) {
    var n = [].slice, r = {}, i = e.amplify = {publish: function (e) {
        if (typeof e != "string")throw new Error("You must provide a valid topic to publish.");
        var t = n.call(arguments, 1), i, s, o, u = 0, a;
        if (!r[e])return!0;
        i = r[e].slice();
        ...
        var s = 0, o = e.split(/\s/), u = o.length, a;
        for (; s < u; s++) {
            e = o[s], a = !1, r[e] || (r[e] = []);
            var f = r[e].length - 1, l = {callback: n, context: t, priority: i};
            for (; f >= 0; f--)if (r[e][f].priority <= i) {
    ...
    function i(e, i) {
        n.addType(e, function (s, o, u) {
            ...
            if (o === t) {
                ...
                i.removeItem(s)
            } else if (o === null)i.removeItem(s); else {
    ...
    (function () {
        ...
        var e = document.createElement("div"), r = "amplify";
        ...
        n.addType("userData", function (i, s, o) {
            e.load(r);
            var u, a, f, l, c, h = s, p = (new Date).getTime();
            if (!i) {
                h = {}, c = [], l = 0;
...
}(this.amplify = this.amplify || {}), function (e, t) {
    "use strict";
    function n() {
    }
    ...
    e.request = function (t, s, o) {
        ...
        var a = {abort: n}, f = e.request.resources[u.resourceId], l = u.success || n, c = u.error || n;
...
}(amplify), function (e, t, n) {
    "use strict";
    var r = ["status", "statusText", "responseText", "responseXML", "readyState"], i = /\{([^\}]+)\}/g;
    e.request.types.ajax = function (i) {
        return i = t.extend({type: "GET"}, i), function (s, o) {
            var u, a, f = i.url, l = o.abort, c = t.extend(!0, {}, i, {data: s.data}), h = !1, p = {readyState: 0, setRequestHeader: function (e, t) {
            ...
            }, e.publish("request.ajax.preprocess", i, s, c, p), t.extend(c, {isJSONP: function () {
            ...
            }}), c.cache && c.isJSONP() && t.extend(c, {cache: !0}), t.ajax(c), o.abort = function () {
                p.abort(), l.call(this)
            }
        }
    ...
    e.store && (t.each(e.store.types, function (t) {
        s[t] = function (n, r, i, o) {
            var u = s._key(r.resourceId, i.cacheURL(), i.data), a = e.store[t](u);
            if (a)return i.success(a), !1;
            var f = o.success;
            o.success = function (r) {
                e.store[t](u, r, {expires: n.cache.expires}), f.apply(this, arguments)
            }
        }
    ...
    }), e.request.decoders = {jsend: function (e, t, n, r, i) {
        ...
        var o = s.success, u = s.error, a = t.isFunction(n.decoder) ? n.decoder : n.decoder in e.request.decoders ? e.request.decoders[n.decoder] : e.request.decoders._default;
        if (!a)return;
